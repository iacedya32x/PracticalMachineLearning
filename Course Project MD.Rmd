...
## Final Results
When applying the decision tree results to the 20 observations that were held out from the modeling, 18 of the 20 observations were correctly predicted which implies an out-of-sample error of 10%.
